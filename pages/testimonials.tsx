      ...
      <div className='to-zinc-900 shadow-zinc-500'>
        <section >
          ...
          <div>
            ...
            <img src="../assets/image/Rectangle 13.png" alt="linea Azul" className="absolute w-7 h-[7px] left-[190px] top-[1525px] bottom-[1584px]" />
            <p className="font-Mulish text-[16px] absolute w-[280px] h-[160px] left-[190px] top-[1574px]">
              Lifestyle choices vary, which is why we take the time to learn about your individual situation and requirements.</p>
            <br />
            <p className="font-Mulish text-[16px] absolute w-[280px] h-[160px] left-[190px] top-[1670px]"> We’ll assist you from start to ﬁnish, ensuring you have the insight and knowledge needed to succeed.
            </p>
          </div>

          {/* Card y su información. */}

          <div className="bg-[#FFFFFF] absolute w-[497px] h-[396px] left-[539px] right-[244px] top-[1380px] bottom-[1340px] 
              rounded-[10px] box-content shadow-lg shadow-slate-400"></div>

          <div className="bg-[#D9D9D9] absolute w-[68px] h-[65px] left-[753px] top-[1407px] rounded-full"></div>

          <h2 className="absolute w-[190px] h-[22px] left-[692px] top-[1496px] font-Nunito font-semibold text-[#07469C] text-[20px]">Residency Programs</h2>

          <br />
          <p className="absolute w-[442px] h-[176px] left-[566px] right-[272px] top-[1552px] bottom-[1388px]
                font-Mulish font-normal text-[16px]">
            Colombian residency safeguards against future instability and opens up a world of opportunities for investors and their families.
            A Golden Visa permit provides visa-free access to many countries across the globe.
          </p>
          <img src="../assets/image/Rectangle 13.png" alt="line" className="absolute w-7 h-[7px] left-[773px] top-[1532px] bottom-[1577px]" />
          <button className="absolute items-center p-5 rounded-[12.64px] gap-3 w-[157px] h-[44px] left-[722px] right-[428px] 
                top-[1684px] bottom-[1388px] bg-[#0099E1] rounded-[12.64px]font-Poppins font-medium text-[15.8px] text-center text-white">
            <Link href="/signup">
              <p className='font-poppins  text-center order-[0] flex-none flex-grow-0 text-base h-6 gap-3 text-white text-[15.8px] content-center left-[1024px] top-[46px] bottom-[761.5px]'>
                Get started
              </p>
            </Link>
          </button>
          ...
          <div>
            <h2 className='absolute w-[609px] h-[35px] left-[335px] top-[1870px] font-Nunito font-semibold text-center text-[32px] text-[#07469C]'>Why Choose Us</h2>
            <img src="../assets/image/Rectangle 13.png" alt="line" className="absolute w-7 h-[7px] left-[626px] right-[626px] top-[1918px] bottom-[1191px]" />
          </div>
          ...
          <div>
            ...
            <img src="../assets/image/flechaarriba.png" className='absolute w-[14] h-[16] left-[1085px] right-[181px] top-[2248px] bottom-[882px] animate-bounce' />
          </div>
          <h2 className='absolute font-Mulish font-medium text-[14px] w-[75px] h-[18px] left-[1121px] right-[84px] top-[2247px] bottom-[851px]'>Back to top</h2>
